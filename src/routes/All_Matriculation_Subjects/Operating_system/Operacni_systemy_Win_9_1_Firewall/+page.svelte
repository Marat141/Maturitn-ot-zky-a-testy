	...
	<div class="layout">
		...
		<div class="content">
			<div class="header-with-button">
				<h1>Windows – část 9.1: Firewall (Zápisky z PDF cvičení)</h1>
				<a
					href="/All_Matriculation_Subjects/Operating_system/Operacni_systemy_Win_9_1_Firewall/Exam-Operacni_systemy_Win_9_1_Firewall"
					class="ButtonExam"
				>
					Napsat si test
				</a>
			...
			<section class="note">
				<h2>📦 Instalace a konfigurace FTP serveru</h2>
				<ul>
					<li>Instalace FileZilla Server – služba běžící na pozadí</li>
					<li>Výchozí port pro FTP: 21</li>
					<li>Konfigurace GUI: adresa 127.0.0.1, port 14147</li>
					<li>Možnost aktivace TLS, pasivních portů atd.</li>
				</ul>
			</section>

			<section class="note">
				<h2>🔍 Testování lokálního připojení</h2>
				<ul>
					<li>Ověření portu 21 přes <code>netstat</code></li>
					<li>Test přes <code>ftp://127.0.0.1/</code> nebo FTP klienta</li>
					<li>Úspěšné připojení = funkční server</li>
				</ul>
			</section>

			<section class="note">
				<h2>🛡️ Konfigurace firewallu – GUI</h2>
				<ul>
					<li>Otevřít „Windows Firewall s pokročilým zabezpečením“</li>
					<li>Nové pravidlo > Port > TCP > port 21</li>
					<li>Akce: Povolit připojení</li>
					<li>Profily: Doména, Privátní, Veřejný</li>
					<li>Název pravidla: „Povolit FTP (port 21)“</li>
				</ul>
			</section>

			<section class="note">
				<h2>💻 Konfigurace firewallu – PowerShell</h2>
				<ul>
					<li>Příkaz: <code>New-NetFirewallRule</code></li>
					<li>Parametry: TCP, LocalPort 21, Action Allow, Profile Any</li>
					<li>Ověření: <code>Get-NetFirewallRule</code></li>
				</ul>
			</section>

			<section class="note">
				<h2>🔄 Úprava na jiný port (např. 2121)</h2>
				<ul>
					<li>Změnit port ve FileZilla Serveru</li>
					<li>Vytvořit nové pravidlo ve firewallu (GUI + PowerShell)</li>
					<li>Ověřit připojení z jiného zařízení</li>
				</ul>
			</section>

			<a href="/PDF/Operacni_systemy_Win_9_1_Firewall.pdf" class="ButtonExam" download>
				📄 Stáhnout PDF
			</a>
		</div>
	</div>
