	...
	<div class="layout">
		...
		<div class="content">
			<div class="header-with-button">
				<h1>Mac OS – část 1.7: Terminál</h1>
				<a
					href="/All_Matriculation_Subjects/Operating_system/Operacni_systemy_MAC_1_7_Terminal/Exam_Operacni_systemy_MAC_1_7_Terminal"
					class="ButtonExam"
				>
					Napsat si test
				</a>
